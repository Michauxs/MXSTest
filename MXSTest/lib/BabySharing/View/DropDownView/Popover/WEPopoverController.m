...
+ (WEPopoverContainerViewProperties *)defaultContainerViewProperties {
    ...
    if (defaultProperties) {
        ...
        if (OSVersionIsAtLeast(7.0)) {
            ...
            bgImageName = [resourceBundle pathForResource:@"popoverBg-white@2x" ofType:@"png"];
            ...
            props.upArrowImageName = [resourceBundle pathForResource:@"popoverArrowUp-white@2x" ofType:@"png"];
            props.downArrowImageName = [resourceBundle pathForResource:@"popoverArrowDown-white@2x" ofType:@"png"];
            props.leftArrowImageName = [resourceBundle pathForResource:@"popoverArrowLeft-white@2x" ofType:@"png"];
            props.rightArrowImageName = [resourceBundle pathForResource:@"popoverArrowRight-white@2x" ofType:@"png"];
