...
#import "AYNotifyUnFollowBtnView.h"
...
@implementation AYNotifyUnFollowBtnView
- (void)postPerform {
    [super postPerform];
    [self setBackgroundImage:PNGRESOURCE(@"command_following") forState:UIControlStateNormal];
}
