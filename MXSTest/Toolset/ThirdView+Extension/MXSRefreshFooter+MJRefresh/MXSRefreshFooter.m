...
- (UIImageView*)loadingView {
	if (!_loadingView) {
		...
		UIImageView *loading = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"loading_0"]];
...
- (UIImageView*)noMoreDataSign {
	if (!_noMoreDataSign) {
		UIImageView *sign = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"icon_nomore_sign"]];
